...
class MessagingServiceTest : WordSpec() {
    ...
    private val messageContentToBeSent = TextContent("Message content")
    private val mockedTimeStamp = ("2019-07-22T23:46:18.647Z")
    private val messageResponse = UserMessage(id = 1, timestamp = mockedTimeStamp)
    private val messageResponse2 = UserMessage(id = 2, timestamp = mockedTimeStamp)
    private val message1ToBeSentObject = UserMessagePost(user1Id, user2Id, messageContentToBeSent)
