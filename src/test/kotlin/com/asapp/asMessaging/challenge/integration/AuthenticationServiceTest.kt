...
class AuthenticationServiceTest : WordSpec() {
    ...
    private val user1PostRequest = com.asapp.asMessaging.challenge.model.UserPostRequest(username1, passwordUser1)
    private val user2PostRequest = com.asapp.asMessaging.challenge.model.UserPostRequest(username2, passwordUser2)
